...
async def callback_thinking_menu(callback: CallbackQuery):
    ...
    preset_block = (
        "🎚 <b>Пресеты стиля ответа</b> (чем отличаются):\n\n"
        "• <b>Серьезный</b> — сухо и по делу, минимум эмоций, для рабочих задач\n"
        "• <b>Нейтральный</b> — спокойно и универсально, подходит для большинства запросов\n"
        "• <b>Веселый</b> — с юмором, для креатива и развлечения\n"
        "• <b>Друг</b> — тепло и просто, как близкий друг\n\n"
